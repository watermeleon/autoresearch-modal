...
4. **Verify Modal is configured**: The human should have already run `modal run modal_app.py --command prepare` to prepare data on Modal. If training fails with a data error, tell the human to run that command.
